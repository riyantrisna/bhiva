...
$config['path_language'] = $config['base_url'].'files/images/language/';
$config['path_language_upload'] = 'files/images/language/';
$config['path_user'] = $config['base_url'].'files/images/user/';
$config['path_user_upload'] = 'files/images/user/';
$config['path_slider'] = $config['base_url'].'files/images/slider/';
