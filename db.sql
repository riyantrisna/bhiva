...
MySQL - 10.1.37-MariaDB : Database - bhivaid_website
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`bhivaid_website` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `mst_ticket`(`ticket_id`,`ticket_is_type_visitor`,`ticket_status`,`insert_user_id`,`insert_datetime`,`update_user_id`,`update_datetime`) values (1,1,1,5,'2019-09-24 21:42:30',5,'2019-10-28 07:15:08');
...
insert  into `mst_ticket_price`(`ticketprice_ticket_id`,`ticketprice_visitortype_id`,`ticketprice_start`,`ticketprice_end`,`ticketprice_price_local`,`ticketprice_price_foreign`) values (1,1,'2019-08-01','2019-09-01','80000.00','200000.00'),(1,1,'2019-10-01','2019-10-31','70000.00','170000.00'),(1,1,'2019-11-01','2019-11-09','75000.00','175000.00');
