...
CREATE TABLE `mst_ticket_price` (
  ...
  `ticketprice_start` datetime DEFAULT NULL,
  `ticketprice_end` datetime DEFAULT NULL,
...
CREATE TABLE `mst_tourpackages_price` (
  ...
  `tourpackagesprice_start` datetime DEFAULT NULL,
  `tourpackagesprice_end` datetime DEFAULT NULL,
...
CREATE TABLE `mst_tourpackages_testimony` (
  ...
  `tourpackagestesti_is_process` tinyint(1) DEFAULT NULL COMMENT '0=no,1=yes',
  `insert_user_id` bigint(20) DEFAULT NULL,
  `insert_datetime` datetime DEFAULT NULL,
  `update_user_id` bigint(20) DEFAULT NULL,
  `update_datetime` datetime DEFAULT NULL,
