...
insert  into `mst_ticket`(`ticket_id`,`ticket_status`,`insert_user_id`,`insert_datetime`,`update_user_id`,`update_datetime`) values (1,1,5,'2019-09-24 21:42:30',5,'2019-09-28 00:04:09');
...
insert  into `mst_ticket_price`(`ticketprice_ticket_id`,`ticketprice_visitortype_id`,`ticketprice_start`,`ticketprice_end`,`ticketprice_price_local`,`ticketprice_price_foreign`) values (1,1,'2019-08-01','2019-09-01','80000.00','200000.00'),(1,1,'2019-10-01','2019-10-31','70000.00','170000.00');
...
insert  into `mst_ticket_pricedefault`(`ticketpricedef_ticket_id`,`ticketpricedef_visitortype_id`,`ticketpricedef_price_local`,`ticketpricedef_price_foreign`) values (1,1,'15000.00','150000.00'),(1,2,'12000.00','120000.00'),(1,3,'11000.00','110000.00');
...
insert  into `mst_tourpackages_img`(`tourpackagesimg_tourpackages_id`,`tourpackagesimg_order`,`tourpackagesimg_img`) values (5,1,'7f9d28420ca60586efc8a8adf9265e0f.jpeg'),(5,2,NULL),(5,3,NULL),(5,4,NULL),(6,1,'e5b55f02e1e619a86352caf7d0d19c96.png'),(6,2,'7ec44560a802d41d43d7ff2ea9860529.png'),(6,3,NULL),(6,4,NULL);
...
insert  into `mst_tourpackages_price`(`tourpackagesprice_tourpackages_id`,`tourpackagesprice_start`,`tourpackagesprice_end`,`tourpackagesprice_price_local`,`tourpackagesprice_price_foreign`) values (5,'2019-09-01','2019-09-30','1800000.00','2800000.00'),(5,'2019-10-01','2019-10-31','1900000.00','2900000.00'),(5,'2019-11-01','2019-11-30','1700000.00','2700000.00'),(6,'2019-10-30','2019-10-31','22.00','222.00'),(6,'2019-11-01','2019-11-08','2222.00','2222.00');
...
insert  into `mst_tourpackages_text`(`tourpackagestext_tourpackages_id`,`tourpackagestext_lang`,`tourpackagestext_name`,`tourpackagestext_text`) values (5,'en','Paket Keliling Jogja','<p>Paket Keliling Jogja Paket Keliling Jogja Paket Keliling Jogja<br></p>'),(5,'id','Paket Keliling Jogja','<p>Paket Keliling Jogja Paket Keliling Jogja Paket Keliling Jogja<br></p>'),(6,'en','Sss','<p>sssss<br></p>'),(6,'id','ssss','<p>sssss<br></p>');
