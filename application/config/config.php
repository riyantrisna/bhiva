...
$config['path_language_upload'] = 'files/images/language/';
$config['path_user'] = $config['base_url_image'].'files/images/user/';
$config['path_user_upload'] = 'files/images/user/';
$config['path_slider'] = $config['base_url_image'].'files/images/slider/';
$config['path_slider_upload'] = 'files/images/slider/';
$config['path_service'] = $config['base_url_image'].'files/images/service/';
$config['path_service_upload'] = 'files/images/service/';
$config['path_aboutus'] = $config['base_url_image'].'files/images/aboutus/';
$config['path_aboutus_upload'] = 'files/images/aboutus/';
$config['path_contact'] = $config['base_url_image'].'files/images/contact/';
$config['path_contact_upload'] = 'files/images/contact/';
$config['path_gallery'] = $config['base_url_image'].'files/images/gallery/';
$config['path_gallery_upload'] = 'files/images/gallery/';
$config['path_destination'] = $config['base_url_image'].'files/images/destination/';
$config['path_destination_upload'] = 'files/images/destination/';
$config['path_venue'] = $config['base_url_image'].'files/images/venue/';
$config['path_venue_upload'] = 'files/images/venue/';
$config['path_tourpackages'] = $config['base_url_image'].'files/images/tourpackages/';
